          ...
          return (
            <div className="item" key={article.id}>
              <div className="header-image">
                {article.video ? (
                  <iframe src={article?.video} title="Umra ziyorati: ko‘zga ko‘rinmaydigan jihatlar haqida 10 ta maslahat" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                ) : (
              ...
              <div className="info">
                ...
                <div className="description">{truncateDescription(article.post_content, 50)}</div>
